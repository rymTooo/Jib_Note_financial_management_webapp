"""
Django settings for jibnote project.
...
SECRET_KEY = 'django-insecure-&mnf=sl!(9q=6b!70r5uxgy)z%=je3zd2=s33w0)0=e8+tuo7b'
...
WSGI_APPLICATION = 'jibnote.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME' : 'jib_note',#name of the data base
        'USER' : 'root',#username
